...
# df["data_labels"] = data_labels
#
# df.to_csv("data/data_labels_absolute_8.csv", index=False)

# import os
# os.chdir(r"D:\Pycharm Projects")
# import pandas as pd
#
# data_labels_df = pd.read_csv(rf"ThesisFinal\Game Theoretical Adversarial Deep Learning\data\data_labels_absolute_8.csv")
#
# data_labels = list(data_labels_df["data_labels"])
#
...
# train_data_labels_df = DataFrame()
# train_data_labels_df["data_labels"] = train_data_labels
# train_data_labels_df.to_csv(rf"ThesisFinalData\smaller_scaled_images_rolling_window_6\train\train_data_labels_absolute_8.csv", index=False)
#
...
# test_data_labels_df = DataFrame()
# test_data_labels_df["data_labels"] = test_data_labels
# test_data_labels_df.to_csv("ThesisFinalData/smaller_scaled_images_rolling_window_6/test/test_data_labels_absolute_8.csv", index=False)
